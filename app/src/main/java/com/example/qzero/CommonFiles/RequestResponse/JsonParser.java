...
public class JsonParser {
	...
	public String executePostJson(String targetURL, String urlParameters, int timeout) {
		URL url;
		HttpURLConnection connection = null;
		try {
			// Create connection
			...
			connection.setRequestProperty("X-APPKEY","ztABV1khXdRiO00GUO0V7aGZ8T87fN50DvvUq0DrvUgNIB235mQvAQhUtQT14Uio");
			connection.setRequestProperty("X-DEVIDE_ID","1233");
			connection.setRequestProperty("X-DEVIDE_TYPE","android");
